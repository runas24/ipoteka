...
document.getElementById("loanForm").addEventListener("submit", function(event) {
    ...
    google.script.run.submitForm(fullName, loanDate, maxLoanAmount);
    ...
    setTimeout(function() {
        ...
        alert("Заявка отправлена на рассмотрение. Максимальная сумма кредита: " + maxLoanAmount.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, " ") + " тенге");
